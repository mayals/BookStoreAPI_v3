...
class ReviewCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        except IntegrityError:  #unique_together = ("user", "book") in models.Rview
            raise validators.ValidationError({"detail": "This user has already created a review about this book"})
